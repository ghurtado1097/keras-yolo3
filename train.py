...
if __name__ == '__main__':
    ...
    parser.add_argument('train_path', type=str, help='Path to the train file that contains images and objects to detect')
    parser.add_argument('log_dir', type=str, help='Directory where the model and trained weights will be stored')
    parser.add_argument('classes_path', type=str, help='Path to file that contains the classes of objects to detect')
    parser.add_argument('anchors_path', type=str, help='Path to file that contains the anchors to be used')
    parser.add_argument('weights_path', type=str, help='Path to file where trained weights are found')
    ...
    parser.add_argument('--image_width', type=int, help='Width of images')
    parser.add_argument('--image_height', type=int, help='Height of images')
